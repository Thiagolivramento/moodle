...
/**
 * Assign grades entity class implementation assign
 *
 * This entity defines all the assign grades columns and filters to be used in any report.
 *
 * @package     mod_assign
...
class assign_grades extends base {
    ...
    protected function get_default_entity_title(): lang_string {
     ...
     /**
      * Initialise the entity, add all assign grades fields
      *
      * @return base
      */
    ...
    protected function get_all_columns(): array {
        ...
        $assigngradealias = $this->get_table_alias('assign_grades');
        ...
        $columns[] = (new column(
           ...
           ->add_field("{$assigngradealias}.grade");

        // Assign grade time modified column.
        $columns[] = (new column(
           'timemodified',
           ...
           ->set_is_sortable(true)
           ->add_field("{$assigngradealias}.timemodified")
    ...
    protected function get_all_filters(): array {
        ...
        $filters[] = (new filter(
            text::class,
            'gradeselector',
            new lang_string('grade', 'mod_assign'),
            $this->get_entity_name(),
            "{$assigngradealias}.grade"
        ));
        return $filters;
    }
}
