...
final class quiz_test extends core_reportbuilder_testcase {
    ...
    public function test_datasource_default(): void {
        ...
        $this->assertEquals([
            ["<a href=\"{$courseoneurl}\">{$course->fullname}</a>", $quiz->name],
    ...
    public function test_datasource_non_default_columns(): void {
        ...
        $this->assertEquals($quiz->name, $quizname);
    ...
    public function test_stress_datasource(): void {
        ...
        $this->datasource_stress_test_columns(quiz::class);
        $this->datasource_stress_test_columns_aggregation(quiz::class);
        $this->datasource_stress_test_conditions(quiz::class, 'quiz:name');
    }
}
